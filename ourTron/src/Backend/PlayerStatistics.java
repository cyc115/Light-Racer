 ...
 * @param user1 
 * @param user2
 * @return an int[] of 2 cells where the first cell is the number of user1's wins against user2, and the second cell is the number of user2's wins against user1
 */
	public static int[] user1VsUser2Wins(User user1, User user2){
	 ...
	 * @return a String[] filled with the name of each user in order from best to worst
	 */
